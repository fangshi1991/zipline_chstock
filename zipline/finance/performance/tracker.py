...
class PerformanceTracker(object):
    ...
    def __init__(self, sim_params, env):
        ...
        # inception.这个性能期将从一开始就跨越整个模拟。在period 中
        ...
        # this performance period will span just the current market day 这个表现期将跨越当前的市场日
    ...
    def _handle_event_price(self, event):
        #print u'进入handle_event_price程序'
    ...
    def process_transaction(self, event):
        print event.sid,event.amount,event.dt,event.price,event.order_id, event.commission
        #print u'交易主程序'
    # 交易的主程序                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         那慢慢木木木木木木木木木木木木木木木木木木木木木木木木木木木木木木木木                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
        self._handle_event_price(event)
        #print u'进入第二程序'
        self.txn_count += 1
    ...
    def process_order(self, event): # 对order命令进行处理
    # 中间有两个计算记录总体表现的，记录今天表现的
        #print u'cumulative_performance.record_order的内容'
        self.cumulative_performance.record_order(event)
        #print u'todays_performance.record_order的内容情况'

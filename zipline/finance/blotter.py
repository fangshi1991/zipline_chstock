...
class Blotter(object):
    ...
    def __init__(self):
    # transact_partial为交易部分，包含（成交滑点，命令费用等）
...
""".strip().format(class_name=self.__class__.__name__,
    ...
    def order(self, sid, amount, style, commission,order_id=None,give_price = None,):
    ...
    def process_trade(self, trade_event):# 交易执行
        #print trade_event
        #print u'上面那是TRADE_EVENT'
        #print trade_event,u'这里的情况'
        ...
        #print u'这里的情况很奇怪'
        if trade_event.change >=0.098 and trade_event.open==trade_event.close == trade_event.high == trade_event.low:
            #print self.open_orders
            #print u'这里的情况很奇怪'
    ...
    def process_transactions(self, trade_event, current_orders):
        #print trade_event
    #对交易进行处理，trade_event表示当天的股票行情，current_orders表示当天的操作命令
